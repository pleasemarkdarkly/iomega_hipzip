...
#ifdef CYGBLD_BUILD_REDBOOT_WITH_WEAK_CYGSTART
externC void cyg_start( void ) CYGBLD_ATTRIB_WEAK;
#endif
...
# endif
#ifdef CYGSEM_REDBOOT_BOOT_SCRIPT_TIMEOUTS
    if (script) {
...
#else
    res = _GETS_TIMEOUT;
#endif  // CYGSEM_REDBOOT_BOOT_SCRIPT_TIMEOUTS
#endif  // CYGFUN_REDBOOT_BOOT_SCRIPT
