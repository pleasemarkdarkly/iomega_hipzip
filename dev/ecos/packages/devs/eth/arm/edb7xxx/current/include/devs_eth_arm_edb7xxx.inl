...
#include <cyg/hal/hal_edb7xxx.h>        // _VARIANT_EP7312
...
// Register setup on the cs8900a interface for cirrus logic boards has apparently
// changed a few times. Some of the boards are set up with stepping of 4 (7212?) and
// others have 2 (7312?).
#ifdef CYGHWR_HAL_ARM_EDB7XXX_VARIANT_EP7312
# define CS8900A_step 2
#else
# define CS8900A_step 4
#endif  // _VARIANT_EP7312
...
# if defined(CYGPKG_REDBOOT) && defined(CYGPKG_REDBOOT_NETWORKING) && defined(CYGSEM_REDBOOT_FLASH_CONFIG)
...
static cs8900a_priv_data_t cs8900a_eth0_priv_data = { 
    base : (cyg_addrword_t) CYGDAT_DEVS_ETH_ARM_EDB7XXX_ETH0_BASE_ADDRESS,
