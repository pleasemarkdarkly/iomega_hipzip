...
#include <pkgconf/system.h>  // for board types
...
// The uart divisor isn't used for 90mhz clock rates, since all the timings
// no longer divide evenly; instead, it's best to use the divisors below as reference
// points, and test out close values based on the equation used for normal operation
#define UART_DIVISOR  288000
//#define UART_DIVISOR  275356
#define UART_BITRATE(baud)  \
    ((baud==  9600)? 27 :   \
     (baud== 19200)? 13 :   \
     (baud== 38400)?  6 :   \
     (baud== 57600)?  4 :  0)
...
// Random and unique ID registers
...
#if defined(CYGHWR_HAL_ARM_EDB7XXX_BOARD_VARIANT_DHARMA_V2)

// Memory mapped GPIO
#define MMGPI 0x30400000
#define MMGPO 0x30800000

// Memory mapped expansion interrupts
#define XINTSR_XINT0 (1<<0)
