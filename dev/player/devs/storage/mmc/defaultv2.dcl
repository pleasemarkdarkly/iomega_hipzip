...
/* See comment below */
#define HW_MMC_HARD_RESET_PIN0   0x00
#define HW_MMC_PORT0             PBDR
#define HW_MMC_DDR0              PBDDR
#define HW_MMC_CLK0              0x10
#define HW_MMC_CMD0              0x20
#define HW_MMC_DATA0             0x40
// this is on the mm gpio
// Since this has to be in the asm, I can't have MMGPI_MMOD_CD0 for example from mmgpio.h.
// Also, mmc_phys.h uses these to set pins in the normal GPIO registers, so this is really
// the safest way to go right now.
#define HW_MMC_CARD0             0x00

// controller 1 definitions
#define HW_MMC_HARD_RESET_PORT1  PBDR
#define HW_MMC_HARD_RESET_DDR1   PBDDR
#define HW_MMC_HARD_RESET_PIN1   0x00
