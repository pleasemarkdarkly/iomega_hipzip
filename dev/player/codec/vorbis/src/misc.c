...
static double VFLOAT(ogg_int32_t a,ogg_int32_t ap){
  return ldexp((double)a,(double)ap);
}

void _analysis_output(char *base,int i,ogg_int32_t *v,int point,
		      int n,int dB){
  int j;
  FILE *of;
  char buffer[80];
