// dp_hw.h: hardware definitions for the dataplay drive
...
// wait state/bus access configuration
// dc: this is tweaked as tight as it will go, 6 wait states works unless you use
// -O2 to compile, in which case you need more wait states
#define DP_MEMCFG_REG  (MEMCFG1)  // dharma
#define DP_MEMCFG_MASK     (0x0000ff00)  // bits to mask off first
//#define DP_MEMCFG_REG      (MEMCFG2)     // amputee
...
#define DP_MEMCFG_VAL ((MEMCFG_WAIT_STATES((8-WAIT_STATES))|MEMCFG_BUS_WIDTH_8)<<8)
//#define DP_MEMCFG_VAL      (0x00001e00)  //  wait states

// interrupt to use
//#define DP_INTERRUPT   CYGNUM_HAL_INTERRUPT_EINT3
#define DP_INTERRUPT   CYGNUM_HAL_INTERRUPT_EINT1

// register locations

// this is for the amputee hipzip device
//#define DP_BASE_ADDRESS        (0x50000000)
// this is for the dharma board
