...
abort( void )
{
    ...
    // dc- on abort, throw an assertion rather than sitting in an infinite loop and locking the whole system.
    //     regardless of whether assertions are enabled or not, we fail here.
    cyg_assert_fail( __FUNCTION__, __FILE__, __LINE__, "abort()\n");
