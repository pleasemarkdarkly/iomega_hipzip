...
#if defined(CYGHWR_HAL_ARM_EDB7XXX_VARIANT_EP7209) || defined(CYGHWR_HAL_ARM_EDB7XXX_VARIANT_EP7212) || defined(CYGHWR_HAL_ARM_EDB7XXX_VARIANT_EP7312)
...
// default to 9600, and support 14.4, 19.2, 57.6
// #s direct from cirrus docs
#define UART_BITRATE(baud) (baud == 57600 ? 4 : (baud == 19200 ? 14 : (baud == 14400 ? 19 : 28)))
#else
