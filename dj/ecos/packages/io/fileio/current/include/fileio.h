...
#define CYG_FROOT       0x00060000  // Set if is the root directory
...
#define CYG_FILE_TYPE_BLK       4	/* block device */
#define CYG_FILE_TYPE_CHR       5       /* character device */
#define CYG_FILE_TYPE_LNK       6       /* soft link */
#define CYG_FILE_TYPE_DIR       7       /* directory */
