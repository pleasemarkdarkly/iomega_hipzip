...
COMPILER_FLAGS := -D__DHARMA=1 -D__DJ -DDEBUG_MISS -DDISABLE_VOLUME_CONTROL -DDAC_MUTE_DISABLE -DFACTORY_TEST -DSAHARA

MAIN_MODULE := test/emi/current

TARGET_FILE_NAME := emi.exe
