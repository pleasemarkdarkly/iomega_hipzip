...
// (epg,8/6/2001): wide string replacement class

d4_inline c4_WideString::c4_WideString ()
{
    Init(0, 0);
}

d4_inline c4_WideString::c4_WideString (const t4_wchar* ptr)
{
	// (epg,8/6/2001): what is the offset for?
    Init(ptr, ptr ? *ptr : 0);
}

d4_inline c4_WideString::c4_WideString (const void* ptr, int len)
{
    Init(ptr, len);
}

d4_inline const c4_WideString& c4_WideString::operator+= (const c4_WideString& s)
{
    return *this = *this + s;
}

d4_inline const c4_WideString& c4_WideString::operator+= (const t4_wchar* s)
{
    return *this += (c4_WideString) s;
}

d4_inline const t4_wchar* c4_WideString::Data() const
{
    return (const t4_wchar*) (_value + 2);
}

d4_inline c4_WideString::operator const t4_wchar* () const
{
    return Data();
}

d4_inline t4_wchar c4_WideString::operator[] (int i) const
{
    return Data()[i];
}
    
d4_inline int c4_WideString::GetLength() const
{
    return _value[1] != 255 ? _value[1] : FullLength();
}

d4_inline bool c4_WideString::IsEmpty() const
{
    return GetLength() == 0;
}

d4_inline void c4_WideString::Empty()
{
	// (epg,8/6/2001): is this ok?
    *this = (t4_wchar)0;
}

d4_inline bool c4_WideString::operator< (const c4_WideString& a) const
{
	// (epg,8/6/2001): need custom Compare fn for wstr
    return Compare(a) < 0;
}

d4_inline c4_WideString operator+ (const t4_wchar* a, const c4_WideString& b)
{
    return (c4_WideString) a + b;
}

d4_inline c4_WideString operator+ (const c4_WideString& a, const t4_wchar* b)
{
    return a + (c4_WideString) b;
}

d4_inline bool operator== (const t4_wchar* a, const c4_WideString& b)
{
    return b.Compare(a) == 0;
}

d4_inline bool operator== (const c4_WideString& a, const t4_wchar* b)
{
    return a.Compare(b) == 0;
}

d4_inline bool operator!= (const c4_WideString& a, const c4_WideString& b)
{
    return !(a == b);
}
