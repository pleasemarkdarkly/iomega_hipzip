// view.cpp --
// $Id: view.cpp,v 1.14 2002/03/25 20:41:37 wcvs Exp $
...
#elif q4_MULTI && q4_DHARMA

#include <cyg/kernel/kapi.h>

    static cyg_mutex_t g_MetakitMutex;

    d4_inline c4_ThreadLock::c4_ThreadLock ()
    {
        cyg_mutex_init(&g_MetakitMutex);
    }

    d4_inline c4_ThreadLock::Hold::Hold ()
    {
        cyg_mutex_lock(&g_MetakitMutex);
    }

    d4_inline c4_ThreadLock::Hold::~Hold ()
    {
        cyg_mutex_unlock(&g_MetakitMutex);
    }
