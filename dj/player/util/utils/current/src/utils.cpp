...
// dc- this module is included in redboot (no kernel, no dynamic memory, existing defininition of crc) for
//     items in the header, but we dont really want any of the functions here
