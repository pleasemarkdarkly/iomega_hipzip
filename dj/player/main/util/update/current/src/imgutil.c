// imported from openssh, available from:
// http://www.freebsd.org/cgi/cvsweb.cgi/src/crypto/openssh/crc32.c?rev=1.1
...
unsigned int
img_crc32(const unsigned char *s, unsigned int len)
{
	unsigned int i;
