...
compile PlaylistSaveScreen.cpp BitrateMenuScreen.cpp 
compile MultiString.cpp SystemMessageString.cpp MainMenuScreen.cpp VolumeMenuScreen.cpp
compile PlaybackEventHandler.cpp InputGainMenuScreen.cpp
...
export PlaylistSaveScreen.h BitrateMenuScreen.h 
export MultiString.h SystemMessageString.h MainMenuScreen.h VolumeMenuScreen.h
export PlaybackEventHandler.h
export Timers.h InputGainMenuScreen.h
...
build_flags -DDISABLE_VOLUME_CONTROL