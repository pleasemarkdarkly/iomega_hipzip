# cf_only.dcl: cf_only configuration for cf on dharma
...
dist cf_only.a tests/carddetect_test.cpp
...
// dc- MC conflicts with usb interrupt, so make them mutually exclusive for now
