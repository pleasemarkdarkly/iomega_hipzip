# hd_slave.dcl: hd_slave configuration for ata on dharma (cd master)
...
/* hard ata reset code */
#define HW_ATA_BUS_0_HARD_RESET_FUNC		  ata_hard_reset
#define HW_ATA_BUS_0_HARD_RESET_PIN        0x02
#define HW_ATA_BUS_0_HARD_RESET_PORT       PDDR
