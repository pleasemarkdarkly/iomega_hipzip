# dj.dcl: dj configuration for dj (hd master cd slave)
# danc@iobjects.com 6/06/01

# common config
include common.dcl

build_flags -DENABLE_ATA_DRIVES=2
...
#define HW_ATA_BUS_0_MEMCFG_WAITSTATES    2         // 90mHz -> 6 wait states
#define HW_ATA_BUS_0_MEMCFG_WIDTH         3         // 1 = 32 bit, 0 = 16 bit, 3 = 8 bit
...
#define HW_ATA_BUS_0_MASTER_NAME          BLOCK_DEV_HDA_NAME
