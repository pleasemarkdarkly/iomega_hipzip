...
d4_inline c4_WideStringRef::c4_WideStringRef (const c4_Reference& value_)
    : c4_Reference (value_)
{
}
...
d4_inline c4_WideStringProp::c4_WideStringProp (const char* name_) 
    : c4_Property ('W', name_)
{
}
    
d4_inline c4_WideStringProp::~c4_WideStringProp ()
{
}

d4_inline c4_WideStringRef c4_WideStringProp::operator() (const c4_RowRef& rowRef_) const
{
    return c4_Reference (rowRef_, *this);
}

d4_inline const t4_wchar* c4_WideStringProp::Get(const c4_RowRef& rowRef_) const
{
    return operator() (rowRef_);
}

d4_inline void c4_WideStringProp::Set(const c4_RowRef& rowRef_, const t4_wchar* value_) const
{
    operator() (rowRef_) = value_;
}

d4_inline c4_Row c4_WideStringProp::AsRow(const t4_wchar* value_) const
{
    c4_Row row;
    operator() (row) = value_;
    return row;
...
d4_inline c4_Row c4_WideStringProp::operator[] (const t4_wchar* value_) const
{
    return AsRow(value_);
}
