...
// Declarations in this file
    ...
    class d4_DLL c4_WideStringProp;
    class d4_DLL c4_WideStringRef;
...
/////////////////////////////////////////////////////////////////////////////
    ...
    d4_DLLSPEC(c4_WideString) operator+ (const c4_WideString&, const c4_WideString&);
    d4_DLLSPEC(c4_WideString) operator+ (const c4_WideString&, const t4_wchar*);
    d4_DLLSPEC(c4_WideString) operator+ (const t4_wchar*, const c4_WideString&);

    d4_DLLSPEC(bool) operator== (const c4_WideString&, const c4_WideString&);
    d4_DLLSPEC(bool) operator!= (const c4_WideString&, const c4_WideString&);
    d4_DLLSPEC(bool) operator== (const c4_WideString& s1, const t4_wchar* s2);
    d4_DLLSPEC(bool) operator== (const t4_wchar* s1, const c4_WideString& s2);
    d4_DLLSPEC(bool) operator!= (const c4_WideString& s1, const t4_wchar* s2);
    d4_DLLSPEC(bool) operator!= (const t4_wchar* s1, const c4_WideString& s2);
#endif
