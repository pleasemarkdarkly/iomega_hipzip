...
#define PP_EEPROMCmd 0x0040  // EEPROM command
#define PP_EEPROMCmd_Read      0x0200  // Read register
#define PP_EEPROMCmd_Write     0x0100  // Write register
#define PP_EEPROMCmd_Erase     0x0300  // Erase register
#define PP_EEPROMCmd_WriteEn   0x00c0  // Erase/Write enable for CS46 and C46
#define PP_EEPROMCmd_WriteDis  0x0000  // Erase/Write disable for CS46 and C46
#define PP_EEPROMCmd_EraseAll  0x0020  // Erase-All registers for CS46 and C46
#define PP_EEPROMCmd_WriteAll  0x0010  // Write-All registers for CS46 and C46
#define PP_EEPROMCmd_ELSEL     0x0400  // Use ELCS instead of EECS to select the EEPROM

#define PP_EEPROMData 0x0042 // EEPROM data
...
#define PP_RxMiss    0x0130  // Receive miss counter
...
#define PP_RxLength  0x0402  // Receive frame length
