...
#ifndef METAKITCONTENTMANAGER_H_
#define METAKITCONTENTMANAGER_H_
...
class IInputStream;
class CMetakitContentManagerImp;
class IOutputStream;
...
class CMetakitContentManager : public IQueryableContentManager
{
public:
#ifdef INCREMENTAL_METAKIT
    CMetakitContentManager(const char* szFilename);
#else
    CMetakitContentManager();
#endif
    ~CMetakitContentManager();
...
private:
    ...
    CMetakitContentManagerImp*  m_pImp;
};


#endif	// METAKITCONTENTMANAGER_H_
