# cf_onlyv2.dcl: default configuration for cf on v2 dharma
# danc@iobjects.com 6/06/01

include common.dcl

compile cf_hard_reset.c

build_flags -DENABLE_ATA_DRIVES=1

tests carddetect_test.cpp

arch cf_hard_reset.o
dist cf_onlyv2.a tests/carddetect_test.cpp
...
//#define HW_ATA_BUS_0_HARD_RESET_FUNC
...
#define HW_ATA_BUS_0_MASTER_ATA
#define HW_ATA_BUS_0_MASTER_NAME          BLOCK_DEV_HDB_NAME
#define HW_ATA_BUS_0_MASTER_SECTOR_SIZE   512

#define HW_ATA_BUS_0_SLAVE
#define HW_ATA_BUS_0_SLAVE_ATAPI
#define HW_ATA_BUS_0_SLAVE_NAME           BLOCK_DEV_CDA_NAME
#define HW_ATA_BUS_0_SLAVE_SECTOR_SIZE   2048
...
#define HW_ATA_BUS_1_BASE           0x20000000
...
// memcfg info
#define HW_ATA_BUS_1_MEMCFG_REG           MEMCFG1   // memcfg 1
#define HW_ATA_BUS_1_MEMCFG_OFFSET        16        // third byte
#define HW_ATA_BUS_1_MEMCFG_WAITSTATES    3         // 90mHz -> 3 wait states
...
#define HW_ATA_BUS_1_MASTER_NAME         BLOCK_DEV_HDA_NAME
