...
compile atabus.c atadrv.c busctrl.c ataproto.c

build_flags -DENABLE_ATA

tests blkdrv_test.cpp rwc_test.cpp usb_test.c align_test.cpp copyc_test.cpp

arch atabus.o atadrv.o busctrl.o ataproto.o

dist include/atadrv.h
dist tests/blkdrv_test.cpp tests/rwc_test.cpp tests/usb_test.c
dist tests/align_test.cpp tests/copyc_test.cpp
