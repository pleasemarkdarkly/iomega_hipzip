...
void TestStores4()
{
    ...
    B(s33, Serialize memo fields, 0) W(s33a); W(s33b); W(s33c);
    {
        ...
        {
            CFatFile ff;
            ff.Open("s33b",CFatFile::WriteCreate);
            c4_FileStream fs1 (&ff, true);
        ...
        CFatFile ff;
        ff.Open("s33b",CFatFile::ReadOnly);
        c4_FileStream fs2 (&ff, true);
    ...
    B(s35, Datafile with preamble, 0) W(s35a);
    {
        {
            CFatFile ff;
            ff.Open("s35a",CFatFile::WriteCreate);
            c4_FileStream fs1 (&ff, true);
        ...
        {
            CFatFile ff;
            ff.Open("s35a",CFatFile::ReadOnly);
            c4_FileStream fs1 (&ff, true);
    ...
    B(s36, Commit after load, 0) W(s36a); W(s36b);
    {
        ...
        {
            CFatFile ff;
            ff.Open("s36b",CFatFile::WriteCreate);
            c4_FileStream fs1 (&ff, true);
        ...
        CFatFile ff;
        ff.Open("s36b",CFatFile::ReadOnly);
        c4_FileStream fs2 (&ff, true);
