// mk4.h --
// $Id: mk4.h,v 1.22 2002/04/29 12:54:54 wcvs Exp $
...
#define d4_MetaKitLibraryVersion 245    // 2.4.5 release, April 29, 2002

// TODO relocate
typedef unsigned short t4_wchar;
...
class c4_WideStringProp : public c4_Property
{
public:
		/// Construct a new property
    c4_WideStringProp (const char*);
        /// Destructor
    ~c4_WideStringProp ();
    
        /// Get or set a string property in a row
    c4_WideStringRef operator() (const c4_RowRef&) const;
        /// Get a wide string property in a row
    const t4_wchar* Get(const c4_RowRef&) const;
        /// Set a wide string property in a row
    void Set(const c4_RowRef&, const t4_wchar*) const;

        /// Create a row with one string, shorthand for AsRow
    c4_Row operator[] (const t4_wchar*) const;
        /// Create a row with one string
    c4_Row AsRow(const t4_wchar*) const;
};
...
public:
    ...
    /// Used to get or set wide string values.
class c4_WideStringRef : public c4_Reference
{
public:
        /// Constructor
    c4_WideStringRef (const c4_Reference&);
        /// Get the value as string
    operator const t4_wchar* () const;
        /// Set the value to the specified string
    c4_WideStringRef& operator= (const t4_wchar*);
};
