// std.cpp --
// $Id: std.cpp,v 1.6 2001/12/10 20:50:53 wcvs Exp $
...
c4_WideString c4_WideString::Mid(int nFirst_, int nCount_) const
{
    int n = length();
    if (nFirst_ > n)
        nFirst_ = n;
...
int c4_WideString::CompareNoCase(const char* str_) const
{
        // this is not very "standard library-ish" ...
//    return *(const string*) this == str_ ? 0 : stricmp(c_str(), str_);
	return 1;
