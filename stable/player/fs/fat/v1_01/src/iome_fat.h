...
bool iome_read(cyg_uint16 driveno, cyg_uint32 sector, cyg_uint8 *buffer, cyg_uint32 count);
bool iome_write(cyg_uint16 driveno, cyg_uint32 sector, cyg_uint8 *buffer, cyg_uint32 count);
