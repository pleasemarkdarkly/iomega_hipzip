...
// If DEBUG_STARTUP macros are enabled, hook into the LED twiddle macros
//  and use them to do serial I/O. sketchy but useful
...
// SDCONF width settings
#if (CYGHWR_HAL_ARM_EDB7XXX_DRAM_SIZE == 16)
#define SDCONF_SIZE_SETTING 1
#elif (CYGHWR_HAL_ARM_EDB7XXX_DRAM_SIZE == 32)
#define SDCONF_SIZE_SETTING 2        
#else
#error "Unsupported SDRAM size for 7312"
#endif // DRAM_SIZE
...
#elif (CYGHWR_HAL_ARM_EDB7XXX_DRAM_SIZE == 32)
#define MMU_TABLES_SIZE  (0x4000+0x8000+0x1000)  // RAM used for PTE entries
#define DRAM_PA_START    0xC0000000
#define DRAM_LA_END      (0x02000000-MMU_TABLES_SIZE-LCD_BUFFER_SIZE)        
#endif  // DRAM_SIZE
...
#if defined(CYGHWR_HAL_ARM_EDB7XXX_VARIANT_EP7209)
// No DRAM controller
...
//        str     r2,[r1]
        ...
        str     r2,[r1]
        ldr     r1,=SDCONF
        ldr     r2,=SDCONF_CASLAT(2)|SDCONF_SDSIZE(SDCONF_SIZE_SETTING)|SDCONF_SDWIDTH(2)|SDCONF_CLKCTL|SDCONF_SDACTIVE
        str     r2,[r1]
        .endm
...
#elif (CYGHWR_HAL_ARM_EDB7XXX_DRAM_SIZE == 16) || (CYGHWR_HAL_ARM_EDB7XXX_DRAM_SIZE == 32)
#ifdef CYGHWR_HAL_ARM_EDB7XXX_VARIANT_EP7312
// The 16M board is arranged as:
//   0xC0000000..0xC1000000
// The 32M board is arranged as:        
...
// TODO: 72xx 32mb configurations not supported
#if (CYGHWR_HAL_ARM_EDB7XXX_DRAM_SIZE == 32)
#error "32mb configurations for 72xx processors not supported"
#endif
...
/* ROM0 */
        MAP_L1_SEGMENT ROM0_LA_START ROM0_LA_END ROM0_PA MMU_L1_TYPE_Section|MMU_AP_Any|MMU_Cacheable
/* ROM1 */
