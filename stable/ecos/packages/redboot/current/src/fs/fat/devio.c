...
**      NO       if failed
******************************************************************************/
SDBOOL devio_read(INT16 driveno, ULONG lba, UCHAR *buf, UCOUNT n_to_read) /* __fn__ */
{
        ULONG   blockno;
...
**      NO       if failed
******************************************************************************/
SDBOOL devio_write(INT16 driveno, ULONG lba, UCHAR *buf, UCOUNT n_to_write) /* __fn__ */
{
        ULONG   blockno;
